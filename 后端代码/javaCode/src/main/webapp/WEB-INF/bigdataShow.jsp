...
<html>
	...
	<body>
					...
					<div class="flex-cell flex-cell-c" style="padding-right:0;">
						<div class="chart-wrapper">
							...
							<div class="chart-div chart-done">
								<table class="data-t">
									<tr>
										<th><img src="${pageContext.request.contextPath}/static/img/icon-01.png" /></th>
										<td>
											<p><span id="listedCompany">0</span></p>
											<p>上市公司数</p>
										</td>
										<th><img src="${pageContext.request.contextPath}/static/img/icon-02.png" /></th>
										<td>
									...
									<tr>
										<th><img src="${pageContext.request.contextPath}/static/img/icon-03.png" /></th>
										<td>
											<p><span id="totalMarket">0</span></p>
											<p>股票总市值（亿元）</p>
										</td>
										<th><img src="${pageContext.request.contextPath}/static/img/icon-04.png" /></th>
										<td>
									...
									<tr>
										<th><img src="${pageContext.request.contextPath}/static/img/icon-05.png" /></th>
										<td>
											<p><span id="shRatio">0</span></p>
											<p>上市平均市盈率</p>
										</td>
										<th><img src="${pageContext.request.contextPath}/static/img/icon-06.png" /></th>
										<td>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/countUp.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/echarts.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/echarts-map-china.js"></script>
		...
		<script type="text/javascript">
			$(function() {
				...
				//获取统计数据
				$.ajax({
					<%--url: "${pageContext.request.contextPath}/static/data/count-data.json",--%>
					url:'${pageContext.request.contextPath}/getDatajson',
					dataType: "json"
				}).done(function(data) {
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/static/data/ranking-list.json",
					dataType: "json"
				}).done(function() {
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/static/data/region-count.json",
					dataType: "json"
				}).done(function() {
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/static/data/month-count.json",
					dataType: "json"
				}).done(function() {
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/static/data/csrc-industry.json",
					dataType: "json"
				}).done(function() {
